var coffeeShop = {
  ...
  buy: function buyBeans(num){
    ...
    console.log('you now have ' + this.beans + ' beans and ' + this.money + ' shekels')
  },
  ...
  makeDrink: function (drinkType) {
    ...
    }else if (drinkType in this.drinkRequirements === false) {
      console.log("Sorry, we don't make " + drinkType)
    }else if (coffeeShop.beans > coffeeShop.drinkRequirements[drinkType].beansNeeded === false){
